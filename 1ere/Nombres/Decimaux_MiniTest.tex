...
\question[3] Let's study the number \textbf{2721}, given as a \textbf{decimal}.
\begin{parts}
...
\question[2] Convert the \textbf{binary} quantity 1011b into decimal (base 10).
\fillwithdottedlines{14mm}

\question[2]  Convert the \textbf{decimal} quantity 43 into binary (base 2).
\fillwithdottedlines{28mm}

\question \textbf{Bonus.} Convert the quantity 43o \textbf{given in base 8} into binary.
\fillwithdottedlines{28mm}
